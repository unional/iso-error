...
export function createHttpError(status: number, message: string, options?: IsoError.Options) {
  switch (status) {
    case HttpStatus.MultipleChoices: return new MultipleChoices(message, options)
    case HttpStatus.MovedPermanently: return new MovedPermanently(message, options)
    case HttpStatus.Found: return new Found(message, options)
    case HttpStatus.SeeOther: return new SeeOther(message, options)
    case HttpStatus.NotModified: return new NotModified(message, options)
    case HttpStatus.UseProxy: return new UseProxy(message, options)
    case HttpStatus.Unused: return new Unused(message, options)
    case HttpStatus.TemporaryRedirect: return new TemporaryRedirect(message, options)
    ...
    case HttpStatus.PaymentRequired: return new PaymentRequired(message, options)
    ...
    case HttpStatus.NotAcceptable: return new NotAcceptable(message, options)
    case HttpStatus.ProxyAuthenticationRequired: return new ProxyAuthenticationRequired(message, options)
    ...
    case HttpStatus.LengthRequired: return new LengthRequired(message, options)
    case HttpStatus.PreconditionFailed: return new PreconditionFailed(message, options)
    case HttpStatus.PayloadTooLarge: return new PayloadTooLarge(message, options)
    case HttpStatus.UriTooLong: return new UriTooLong(message, options)
    case HttpStatus.UnsupportedMediaType: return new UnsupportedMediaType(message, options)
    case HttpStatus.RangeNotSatisfiable: return new RangeNotSatisfiable(message, options)
    case HttpStatus.ExpectationFailed: return new ExpectationFailed(message, options)
    case HttpStatus.IAmATeapot: return new IAmATeapot(message, options)
    case HttpStatus.MisdirectedRequest: return new MisdirectedRequest(message, options)
    case HttpStatus.UnprocessableEntity: return new UnprocessableEntity(message, options)
    case HttpStatus.Locked: return new Locked(message, options)
    case HttpStatus.FailedDependency: return new FailedDependency(message, options)
    case HttpStatus.TooEarly: return new TooEarly(message, options)
    case HttpStatus.UpgradeRequired: return new UpgradeRequired(message, options)
    case HttpStatus.PreconditionRequired: return new PreconditionRequired(message, options)
    case HttpStatus.TooManyRequests: return new TooManyRequests(message, options)
    case HttpStatus.RequestHeaderFieldsTooLarge: return new RequestHeaderFieldsTooLarge(message, options)
    case HttpStatus.UnavailableForLegalReasons: return new UnavailableForLegalReasons(message, options)
    ...
    case HttpStatus.HttpVersionNotSupported: return new HttpVersionNotSupported(message, options)
    case HttpStatus.VariantAlsoNegotiates: return new VariantAlsoNegotiates(message, options)
    case HttpStatus.InsufficientStorage: return new InsufficientStorage(message, options)
    case HttpStatus.LoopDetected: return new LoopDetected(message, options)
    case HttpStatus.NotExtended: return new NotExtended(message, options)
...
const webPlugin: IsoErrorPlugin = {
  ...
  fromSerializable(obj) {
    switch (obj.name) {
      case 'MultipleChoices': return new MultipleChoices(obj.message)
      case 'MovedPermanently': return new MovedPermanently(obj.message)
      case 'Found': return new Found(obj.message)
      case 'SeeOther': return new SeeOther(obj.message)
      case 'NotModified': return new NotModified(obj.message)
      case 'UseProxy': return new UseProxy(obj.message)
      case 'Unused': return new Unused(obj.message)
      case 'TemporaryRedirect': return new TemporaryRedirect(obj.message)
      ...
      case 'PaymentRequired': return new PaymentRequired(obj.message)
      ...
      case 'NotAcceptable': return new NotAcceptable(obj.message)
      case 'ProxyAuthenticationRequired': return new ProxyAuthenticationRequired(obj.message)
      ...
      case 'LengthRequired': return new LengthRequired(obj.message)
      case 'PreconditionFailed': return new PreconditionFailed(obj.message)
      case 'PayloadTooLarge': return new PayloadTooLarge(obj.message)
      case 'UriTooLong': return new UriTooLong(obj.message)
      case 'UnsupportedMediaType': return new UnsupportedMediaType(obj.message)
      case 'RangeNotSatisfiable': return new RangeNotSatisfiable(obj.message)
      case 'ExpectationFailed': return new ExpectationFailed(obj.message)
      case 'IAmATeapot': return new IAmATeapot(obj.message)
      case 'MisdirectedRequest': return new MisdirectedRequest(obj.message)
      case 'UnprocessableEntity': return new UnprocessableEntity(obj.message)
      case 'Locked': return new Locked(obj.message)
      case 'FailedDependency': return new FailedDependency(obj.message)
      case 'TooEarly': return new TooEarly(obj.message)
      case 'UpgradeRequired': return new UpgradeRequired(obj.message)
      case 'PreconditionRequired': return new PreconditionRequired(obj.message)
      case 'TooManyRequests': return new TooManyRequests(obj.message)
      case 'RequestHeaderFieldsTooLarge': return new RequestHeaderFieldsTooLarge(obj.message)
      case 'UnavailableForLegalReasons': return new UnavailableForLegalReasons(obj.message)
      ...
      case 'HttpVersionNotSupported': return new HttpVersionNotSupported(obj.message)
      case 'VariantAlsoNegotiates': return new VariantAlsoNegotiates(obj.message)
      case 'InsufficientStorage': return new InsufficientStorage(obj.message)
      case 'LoopDetected': return new LoopDetected(obj.message)
      case 'NotExtended': return new NotExtended(obj.message)
